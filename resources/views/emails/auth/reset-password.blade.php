...
<head>
    ...
    <title>{{ __('Reset password', [], $user->language->code ?: 'en') }}</title>
                                ...
                                <tr>
                                    <td valign="top" width="100%">
                                        <table class="full-width-gmail-android" border="0" width="100%"
                                            ...
                                            style="margin: 0px 0px 32px 0px; text-align: center" align="center">
                                            <tbody>
                                                <tr>
                                                    <td class="header center" width="100%"
                                                        style="margin: 0;padding:0; text-align: center;" align="center">
                                                        ...
                                                        <h1 class="header-title"
                                                            ...
                                                            {{ __('Termin-ator Password Reset', [], $user->language->code ?? 'en') }}
                                                        </h1>
                                                    </td>
                                                </tr>
                                            </tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td class="body-text-cell">
                                                                                            <p
                                                                                                ...
                                                                                                {{ __('You have forgotten your password and want to reset it', [], $user->language->code ?? 'en') }}<br>
                                                                                                {{ __('You can set up your new password by clicking on the following link:', [], $user->language->code ?? 'en') }}
                                                                                            </p>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td>
                                                                                            <div align="center">
                                                                                                <a style="width:310px;padding: 11px 23px 11px 23px;border-radius: 32px; color: #ffffff; display: inline-block; font-family: 'Inter', sans-serif; font-size: 16px; line-height:19px; font-weight: 700;text-align: center; text-decoration: none;  -webkit-text-size-adjust: none; margin-top: 32px;  background:#C52E62"
                                                                                                    href="{{ $url }}"
                                                                                                    class="btn">{{ __('Reset password', [], $user->language->code ?? 'en') }}</a>
                                                                                            </div>
                                                                                        </td>
                                                                                    </tr>
                                                                                        ...
                                                                                        <td>
                                                                                            <div align="center">
                                                                                                <p
                                                                                                    ...
                                                                                                    margin-top: 32px;
                                                                                                    word-break: break-word;">
                                                                                                    {{ __('If you did not request this, you can ignore this email. Your password will not change until you access the above link and create a new one.', [], $user->language->code ?? 'en') }}
                                                                                                </p>
                                                                                            </div>
                                                                                        </td>
                                                                                    </tr>
                                                                        ...
                                                                        <td style="width: 100%;">
                                                                            ...
                                                                            <center>
                                                                                <img src="{{ asset('images/logo_terminator.png') }}"
                                                                                    ...
                                                                                    height="25"
                                                                                    style="margin-top:22px;display:block;width:100%;max-width:201px;border:0px;"
                                                                                    width="210" />
                                                                            </center>
