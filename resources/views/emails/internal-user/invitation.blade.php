                                ...
                                <tr>
                                    <td valign="top" width="100%">
                                        <table class="full-width-gmail-android" border="0" width="100%"
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="header center" width="100%" align="center"
                                                                                    ...
                                                                                    <tr>
                                                                                        <td class="body-text-cell">
                                                                                            <p
                                                                                                ...
                                                                                                {{ __('You have been invited for Termin-ator as :Role for your company “:Company“ invited', ['Role' => __($user->internalUser->companyRole->name, [], 'de'), 'Company' => $user->customerCompany->name], $user->language->code ?? 'en') }}<br>
