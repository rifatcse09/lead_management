                                                ...
                                                <tr>
                                                    <td class="header center" width="100%"
                                                        ...
                                                        <h1 class="header-title"
                                                            ...
                                                            {{ __('Termin-ator email address verification', [], $user->language->code ?? 'en') }}
                                                        </h1>
                                                    </td>
                                                </tr>
                                            </tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td class="body-text-cell">
                                                                                            <p
                                                                                                ...
                                                                                                {{ __('Your company :companyName has changed your Termin-ator email address.', ['companyName' => $user->customerCompany->name], $user->language->code ?? 'en') }}<br>
                                                                                                {{ __('For security reasons, we ask you to confirm this new email address by clicking on the following link:', [], $user->language->code ?? 'en') }}
                                                                                            </p>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td>
                                                                                            <div align="center">
                                                                                                ...
                                                                                                <a style="width:310px;padding: 11px 23px 20px 23px;border-radius: 32px; color: #ffffff; display: inline-block; font-family: 'Inter', sans-serif; font-size: 16px; line-height:19px; font-weight: 700;text-align: center; text-decoration: none;  -webkit-text-size-adjust: none; margin-top: 32px;  background:#C52E62"
                                                                                                    href="{{ $url }}"
                                                                                        ...
                                                                                        <td>
                                                                                            <div align="center">
                                                                                                <p
                                                                                                    ...
                                                                                                    margin-top: 20px;
                                                                                                    word-break: break-word;">
                                                                                                    {{ __('After successful verification, you will be able to use Termin-ator again as usual with your new email address and existing password.', [], $user->language->code ?? 'en') }}
                                                                                                </p>
                                                                                            </div>
                                                                                        </td>
                                                                                    </tr>
