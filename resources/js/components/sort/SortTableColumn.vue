<template>
    ...
    <template v-else>
        ...
        <svg width="10" height="13" viewBox="0 0 10 13" fill="none" xmlns="http://www.w3.org/2000/svg" @click="sort" v-if="enable">
                <path d="M5.21941 0L9.12724 4.875H1.31157L5.21941 0Z" fill="#ADB5BD"/>
                <path d="M5.21941 13L9.12724 8.125H1.31157L5.21941 13Z" fill="#ADB5BD"/>
        </svg>
    ...
    export default {
        ...
        watch: {
            direction(newValue, oldValue){
                ...
                delete queries.page;
                const routeObj = {name: route.name,params:{...this.$route.params},  query:{...queries, order_by: this.columnName, direction: this.direction}}
