<template>
    <div class="content px-6">
         <div class="rounded-[15px] bg-white px-[30px] py-[40px] overflow-y-auto pr-[127px] shadow-[1px_4px_28px_rgba(95,_76,_92,_0.18)]">
            ...
            <div class="flex">
             ...
             <div class="relative">
                 <router-link :to="{name: 'intermediary-edit', params:{id: $route.params.id}}">
                     <ButtonGradient
                         class="w-[187px]"
                         type="submit"
                     >
 ...
 const getData = async ()=>{
     try {
         const {data} = await axios.get(route('intermediaries.show', {intermediary : vueRoute.params.id}))
