<template>
  <div class="content bg-white rounded-[15px] shadow-container mx-6 px-[43px] pt-[42px] pb-[62px] min-h-[89vh]">
    ...
    <div class="contents-wrapper">
      ...
      <div class="content flex justify-start gap-x-4 mb-5 text-[#707070]" v-for="history in histories" :key="history.id" :class="{ 'text-[#9D5793]': history.new_status == 'Check Duplicate' }">
