...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::partitionByRange('contact_data_record_histories', 'contact_data_record_id', $partitions);
    }
    ...
    public function down()
    {
        ...
        Schema::deletePartition('contact_data_record_histories',  $partitions);
    }
};
