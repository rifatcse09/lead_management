<template>
  <MultiSelect :searchables="['label']" :hide_search_input="true">
    <template #options-top="{ search, setSearch }">
      <input
        type="text"
        class="search__input outline-none w-full border border-input h-[34px] rounded-[5px] py-[10px] pl-7 pr-2 placeholder:text-[10px] placeholder:text-[#A4A4A4] placeholder:leading-3 text-[10px] text-[#585858] caret-[#1892CE]"
        :placeholder="$t('Search by user first or last name')"
        :value="search"
