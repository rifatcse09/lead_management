<template>
  ...
  <script setup>
    ...
    const getInitialData = async ()=> {
        try {
            const res = await axios.get(route("intermediaries.getBrokerInfo"));
            const idres = await axios.get(route("broker-users.get-prefixId"));
            // console.log(res.data);
            form.broker_id = res.data.broker_id;
            broker_name.value = res.data.broker.name;

            prefix_id.value = idres.data;
        } catch (error) {
            console.log(error);
        }
    }
