<template>
    <div class="multi-select wrapper flex flex-col" :class="$attrs.class">
        <h2
            class="text-input block mb-3 text-formLabel whitespace-nowrap"
                ...
                <slot name="placeholder">
                    ...
                    <template v-else-if="!selected_items_labels.length">
                        <div
                            ...
                            class="text-[16px] leading-8 text-bodyText/60"
                        >
                            {{
                                $t(
...
const emit = defineEmits(["update:modelValue", "opened", "onUpdated"]);
