<template>
  <div class="tr w-min" ref="row">
    ...
    <div class="td" style="width: 190px">{{ contact_data_record.last_appointment? formateDate(contact_data_record.last_appointment.appointment_date) : '' }}</div>
    <div class="td" style="width: 190px">{{ contact_data_record.last_appointment? formateTime(contact_data_record.last_appointment.appointment_time) : '' }}</div>
    ...
    <div class="td" style="width: 300px">{{ contact_data_record.last_appointment? contact_data_record.last_appointment.notes: '' }}</div>
