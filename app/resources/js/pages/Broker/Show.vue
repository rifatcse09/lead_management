<template>
         ...
         <div class="rounded-[15px] bg-white px-[30px] py-[40px] overflow-y-auto pr-[127px] shadow-[1px_4px_28px_rgba(95,_76,_92,_0.18)]">
             ...
             <div class="flex">
                 <div class="w-1/3">
                     ...
                     <p class="text-value text-4 font-[400px] font-inter leading-[19px]">{{ formateDate(broker.created_at) }}</p>
                 </div>
                 ...
                 <div class="w-1/3">
                     ...
                     <p class="text-value text-4 font-[400px] font-inter leading-[19px]">{{ broker.prefix_id }}</p>
                 </div>
                 <div class="w-1/3">
                     <h2 class="label text-formLabel font-inter text-input mb-[10px]">
                         {{ $t("Name") }}
                     </h2>
                     <p class="text-value text-4 font-[400px] font-inter leading-[19px]">{{ broker.name }}</p>
                 </div>
             </div>
            ...
            <div class="flex">
                ...
                <div class="w-2/3">
                    ...
                    <p class="text-value text-4 font-[400px] font-inter leading-[19px]">
                    {{ useGetCountryName(broker.country_iso_code) }}
                    </p>
                </div>
            </div>
            <div class="spacer mt-[35px] col-span-3"></div>
            ...
            <div class="flex">
                <div class="w-1/3">
                    ...
                    <p class="text-value text-4 font-[400px] font-inter leading-[19px]">
                    {{ broker.contact_person_first_name }}
                    </p>
                </div>
                ...
                <div class="w-2/3">
                    ...
                    <p class="text-value text-4 font-[400px] font-inter leading-[19px]">
                    {{ broker.contact_person_last_name }}
                    </p>
                </div>
            </div>
            ...
            <div class="flex">
                ...
                <div class="w-2/3">
                    ...
                    <p class="text-value text-4 font-[400px] font-inter leading-[19px]">
                    {{ broker.contact_person_full_phone_number }}
                    </p>
                </div>
            </div>
             ...
             <div class="relative">
                 <router-link :to="{name: 'broker-edit', params:{id: $route.params.id}}">
                     <ButtonGradient
                         class="w-[187px]"
                         type="submit"
                     >
 ...
 const getData = async ()=>{
     try {
         const{data} = await axios.get(route('brokers.show', {broker : vueRoute.params.id}))
         broker.value = data
     } catch (error) {
