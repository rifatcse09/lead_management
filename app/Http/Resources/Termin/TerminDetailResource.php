...
class TerminDetailResource extends JsonResource
{
    /**
     ...
     public function toArray($request)
     {
         ...
         return [
             ...
             "appointment_relevant_information" => [
                 ...
                 "Franchise"=> $this->franchise ? 'CHF '.$this->franchise : '',
                 "Supplementary insurance"=> $this->supplementary_insurance,
             ...
             'intermediary_feedback'=>$this->intermediaryFeedback
