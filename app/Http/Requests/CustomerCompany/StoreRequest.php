...
class StoreRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            "contact_person_first_name"                                 => ['required', 'max:30', 'regex:/^[\p{L}\p{M}\p{Zs}]+$/u'],
            "contact_person_last_name"                                  => ['required', 'max:30', 'regex:/^[\p{L}\p{M}\p{Zs}]+$/u'],
            ...
            "hierarchy_elements.*"                                      => ['array:hierarchy_level,name,responsible_role,direct_subordinated_role'],
