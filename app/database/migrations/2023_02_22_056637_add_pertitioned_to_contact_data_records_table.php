...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::partitionByRange('contact_data_records', 'id', $partitions);
    }
    ...
    {
        // Schema::deletePartition('contact_data_records', 'id');

        $partitions = [];
        for($i = $this->per_partition; $i<= env('APPROXIMATELY_TOTAL_CONTACT_DATA_RECORDS',  $this->total); $i+= $this->per_partition){
            $partitions[] = 'data'.$i;
        }
        Schema::deletePartition('contact_data_records',  $partitions);
    }
};
