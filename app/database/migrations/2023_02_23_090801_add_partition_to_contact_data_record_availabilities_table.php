...
return new class extends Migration
{
    ...
    public function up()
    {
        // Schema::table('contact_data_record_availabilities', function (Blueprint $table) {
        //     //
        // });
        ...
        Schema::partitionByRange('contact_data_record_availabilities', 'contact_data_record_id', $partitions);
    }
    ...
    public function down()
    {
        ...
        Schema::deletePartition('contact_data_record_availabilities',  $partitions);
    }
};
