...
{
    protected $per_partition = 100000;
    ...
    public function up()
    {
        // Schema::table('contact_data_record_allocates', function (Blueprint $table) {
        //     //
        // });
        ...
        Schema::partitionByRange('contact_data_record_allocates', 'contact_data_record_id', $partitions);
    }
    ...
    public function down()
    {
        ...
        Schema::deletePartition('contact_data_record_allocates',  $partitions);
    }
};
